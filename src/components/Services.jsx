...
const Services = () => {
  return (
    <section id="experience" style={{ padding: '5rem 0', backgroundColor: '#ffffff' }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 3rem' }}>
        ...
        <div style={{
          ...
          <div style={{ marginBottom: '1.5rem' }}>
            <h3 style={{ fontSize: '1.75rem', fontWeight: '700', color: '#1F2937', marginBottom: '0.5rem' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '1.5rem', marginBottom: '1.5rem' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
              ...
              <div>
                ...
                <p style={{ fontSize: '1rem', color: '#1F2937', fontWeight: '600' }}>August 2025 - November 2025</p>
              </div>
            </div>
            
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
              <FaBriefcase style={{ color: '#6B7280', fontSize: '1.1rem' }} />
              <div>
                <p style={{ fontSize: '0.875rem', color: '#6B7280', marginBottom: '0.25rem' }}>Type</p>
                <p style={{ fontSize: '1rem', color: '#1F2937', fontWeight: '600' }}>Remote • Paid</p>
              </div>
            </div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
              ...
              <div>
                <p style={{ fontSize: '0.875rem', color: '#6B7280', marginBottom: '0.25rem' }}>Performance</p>
                <p style={{ fontSize: '1rem', color: '#1F2937', fontWeight: '600' }}>Satisfactory</p>
              </div>
            </div>
          </div>
